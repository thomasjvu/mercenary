import { applyReputationDelta, createReputationEvent } from '@bossraid/raid-core';
...
export function applyReputationEventToProvider(
  ...
  provider.reputation.globalScore = applyReputationDelta(
    provider.reputation.globalScore,
    event.delta.global
  );
