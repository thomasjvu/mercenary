  ...
  return (
    ...
    >
      <div style={{ display: 'grid', gap: 8 }}>
        ...
        <div style={{ fontFamily: monoFont, color: colors.muted, fontSize: 20 }}>
          mercenary-v1 / public surface
        </div>
      </div>
      ...
      >
        ...
        >
          <div style={{ display: 'grid', gap: 16 }}>
            ...
            >
              Native raid routing, live provider readiness, real HTTP workers, and payout logic that
              rewards only successful providers.
            </p>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '0.92fr 1.08fr', gap: 32, flex: 1 }}>
        <div style={{ display: 'grid', gap: 20, alignContent: 'start' }}>
          ...
          <p style={{ fontSize: 32, lineHeight: 1.42, color: colors.muted, maxWidth: 560 }}>
            Mercenary accepts the task, probes live providers, routes the run, evaluates output, and
            settles only successful work.
          </p>
              ...
              {payloadLines.map((line, index) => {
                ...
                return (
                  <div key={line} style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
                    <span style={{ color: colors.lineStrong, fontFamily: monoFont, fontSize: 18 }}>
        ...
        >
          {providers.map((provider) => {
            ...
            const strokeOpacity = interpolate(
              readyProgress,
              [0, 1],
              [0.14, provider.approved ? 0.9 : 0.42]
            );
            ...
            >
              ...
              >
                <div style={{ display: 'grid', gap: 8 }}>
                  ...
                  <div style={{ fontFamily: displayFont, fontSize: 28, fontWeight: 600 }}>
                    {provider.label}
                  </div>
                </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '0.94fr 1.06fr', gap: 34, flex: 1 }}>
        <div style={{ display: 'grid', alignContent: 'start', gap: 18 }}>
          ...
          <p style={{ fontSize: 32, lineHeight: 1.42, color: colors.muted, maxWidth: 620 }}>
            Mercenary settles the approved set only. When three providers land valid work, the
            payout divides into three equal shares.
          </p>
          <div
            style={{
              ...cardBase,
      ...
      >
        ...
        >
          <AbsoluteFill style={{ padding: 28 }}>
            <div
              style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 14, flex: 1 }}
            >
              {[0, 1, 2, 3].map((index) => {
...
const HubRow = ({ label, value }: { label: string; value: string }) => {
  return (
    ...
    >
      ...
      <strong
        style={{ fontFamily: displayFont, fontSize: 28, fontWeight: 600, textAlign: 'right' }}
      >
        {value}
      </strong>
    </div>
