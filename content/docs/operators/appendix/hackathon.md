...
| Venice                              | Strict-private routing prefers Venice-backed providers and keeps the privacy decision visible in routing proof.                      | `examples/strict-private-raid.json`, `pnpm bossraid test:strict-private:e2e`                                                    | Strong now when Venice-backed providers are configured.                                                                                |
...
| MetaMask Cookoff: Venice            | Mercenary calls Venice directly for plan/synthesize and routes Venice-backed provider workstreams.                                   | `packages/venice-client`, `examples/hackathon-venice-raid.json`, strict-private routing proof                                   | Strong when Venice API key or x402 wallet is configured.                                                                               |
...
- MetaMask cookoff Venice example: `examples/hackathon-venice-raid.json`
