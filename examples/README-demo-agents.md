...
cp examples/demo-agents.providers.http.json.example temp/demo-agents/providers.http.json
```
...
Game-raid and strict-private e2e fixtures under `examples/game-raid/` and `examples/strict-private/` remain test-only scenarios.
