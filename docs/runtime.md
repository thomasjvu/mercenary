...
- `BOSSRAID_CHAT_DEFAULT_MAX_TOTAL_COST`: fallback budget for `POST /v1/chat/completions` when clients omit `raid_policy.max_total_cost`; the Phala compose stack defaults it to `0.02`
