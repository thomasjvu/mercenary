...
const rehearsalEnv = {
  ...
  BOSSRAID_X402_RAID_ROUTE_SURCHARGE_USD:
    process.env.BOSSRAID_X402_RAID_ROUTE_SURCHARGE_USD ??
    process.env.BOSSRAID_X402_RAID_PRICE_USD ??
    '0.01',
  BOSSRAID_X402_CHAT_ROUTE_SURCHARGE_USD:
    process.env.BOSSRAID_X402_CHAT_ROUTE_SURCHARGE_USD ??
    process.env.BOSSRAID_X402_CHAT_PRICE_USD ??
    '0.002',
