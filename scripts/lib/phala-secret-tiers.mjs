...
export const PHALA_OPTIONAL_PLAN_KEYS = [
  ...
  'BOSSRAID_DARKBLOOM_API_KEY',
  'BOSSRAID_CHUTES_API_KEY',
...
export function buildDeployDefaults(merged = {}) {
  ...
  const defaults = {
    BOSSRAID_PROVIDERS_FILE: '/app/examples/raids/game-raid/providers.compose.json',
    ...
    // Robinhood Chain + USDG via Marian (Surplus) facilitator — not Base/PayAI.
